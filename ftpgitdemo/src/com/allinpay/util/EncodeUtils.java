...
public class EncodeUtils {
	...
	/**
	 * oriEncoding byte[] -> toEncoding byte[]
	 * 
	 * @param ba
	 *            需要转换格式的byte[]
	 * @param oriEncoding
	 ...
	 * @param toEncoding
	 *            需要转换成的编码格式
	 * @return 转换过编码格式后的byte[]
	 */
	public static byte[] changeEncoding(byte[] ba, Charset oriEncoding, Charset toEncoding) {
		if (toEncoding.equals(oriEncoding)) {
			return ba;
		}
		return new String(ba, oriEncoding).getBytes(toEncoding);
	}
}
